    ...
    actions: [
      {
        ...
        templateFile: "generators/GenericComponent/GenComponent.tsx",
      },
      {
        type: "add",
        path: "components/{{name}}/{{name}}.stories.tsx",
        templateFile: "generators/GenericComponent/GenComponent.stories.tsx",
      },
      {
        type: "add",
        path: "components/{{name}}/{{name}}.spec.tsx",
        templateFile: "generators/GenericComponent/GenComponent.spec.tsx",
      },
      {
        type: "add",
        path: "components/{{name}}/{{name}}.scss",
        templateFile: "generators/GenericComponent/GenComponent.scss",
      },
      {
        type: "add",
        path: "components/{{name}}/{{name}}.d.ts",
        templateFile: "generators/GenericComponent/GenComponent.d.ts",
      },
    ],
  });
