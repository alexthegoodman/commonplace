...
exports.s3Url = exports.cloudfrontUrl = exports.cpGraphqlUrl = exports.cpDomainwp = exports.cpDomain = exports.env = void 0;
exports.env = process.env.NEXT_PUBLIC_APP_ENV;
exports.cpDomain = exports.env === "production" ? "commonplace.social" : "localhost";
exports.cpDomainwp = exports.env === "production" ? "commonplace.social" : "localhost:3000";
