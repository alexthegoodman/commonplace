...
var ERROR_CODES_1 = __importDefault(require("./ERROR_CODES"));
...
var AWS = /** @class */ (function () {
    ...
    AWS.prototype.getUploadDirectory = function () {
        ...
        var month = DateTime.now().toFormat("MM");
        var folder = "".concat(year, "/").concat(month, "/");
        return folder;
    };
    AWS.prototype.getSizeBase64 = function (length) {
        var size = length * (3 / 4);
        return size;
    };
