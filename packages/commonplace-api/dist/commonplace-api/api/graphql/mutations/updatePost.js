...
exports.UpdatePostMutation = void 0;
...
exports.UpdatePostMutation = (0, nexus_1.extendType)({
    ...
    definition: function (t) {
        ...
        t.nonNull.field("updatePost", {
            type: "Post",
            args: {
                postTitleSlug: (0, nexus_1.nonNull)((0, nexus_1.stringArg)()),
                title: (0, nexus_1.nonNull)((0, nexus_1.stringArg)()),
                description: (0, nexus_1.nonNull)((0, nexus_1.stringArg)()),
            },
            resolve: function (_, _a, _b) {
                var postTitleSlug = _a.postTitleSlug, title = _a.title, description = _a.description;
                        ...
                        switch (_c.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, prisma.post.update({
                                        where: {
                                            id: userPost === null || userPost === void 0 ? void 0 : userPost.id,
                                        },
                                        data: {
                                            title: title,
